                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        <View style={{ flexDirection: 'row', marginTop: 15 }}>
                            ...
                            <View style={{ flexDirection: 'column', marginLeft: 15 }}>
                                <Title style={styles.title}>Cu Thảo</Title>
                                <Caption style={styles.caption}>cuthao@gmail.com</Caption>
                            </View>
                        </View>
                    </View>
                    <Drawer.Section style={styles.drawerSection}>
                        <DrawerItem
                            ...
                            inactiveBackgroundColor="#FFAC30"  />
                        <DrawerItem
                            icon={({ color, size }) => {
                        ...
                        <DrawerItem
                            ...
                            activeBackgroundColor="#FFAC30" // Màu nền khi mục đang hoạt động
                            inactiveBackgroundColor="#FFAC30" 
                            />            
                    </Drawer.Section>
                </View>
